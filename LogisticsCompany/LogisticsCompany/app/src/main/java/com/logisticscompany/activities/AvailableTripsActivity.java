...
public class AvailableTripsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     /*   viewTripsPojo=new ArrayList<>();
        viewTripsPojo.add(new ViewTripsPojo("ABC","Vijayawada","9:00 AM","12:00 PM","Guntoor","500 Rs"));
        viewTripsPojo.add(new ViewTripsPojo("ABC","Vijayawada","9:00 AM","12:00 PM","Guntoor","500 Rs"));
        viewTripsPojo.add(new ViewTripsPojo("ABC","Vijayawada","9:00 AM","12:00 PM","Guntoor","500 Rs"));
        viewTripsPojo.add(new ViewTripsPojo("ABC","Vijayawada","9:00 AM","12:00 PM","Guntoor","500 Rs"));
        viewTripsPojo.add(new ViewTripsPojo("ABC","Vijayawada","9:00 AM","12:00 PM","Guntoor","500 Rs"));
        ...
        AvailableTripsAdapter availableTripsAdapter=new AvailableTripsAdapter(this,viewTripsPojo);
        list_view.setAdapter(availableTripsAdapter);*/
    ...
    ValueEventListener valueEventListener = new ValueEventListener() {
        ...
        public void onDataChange(DataSnapshot dataSnapshot) {
            ...
            if (dataSnapshot.exists()) {
                ...
                Toast.makeText(AvailableTripsActivity.this, "No data Found", Toast.LENGTH_SHORT).show();
            }
        }
